...
class ProcessingParser(BaseParser):
    """
    A parser for extracting processing data from HTML tables.
    ...
    def __init__(self):
        """
        Initializes the ProcessingParser with the default table class name.
